			...
			<div id="poststuff">
				<div id="postbox-container-1" class="postbox-container">
					<div class="postbox">
						...
						<h3 class="hndle"><span><?php _e('Subscribe to our mailing list',WP_AWP); ?></span></h3> 
						<div class="option">
								...
								<form action="http://varunsridharan.us11.list-manage.com/subscribe/post?u=438373310b9f3b6302526f737&amp;id=71f582aed1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
									<div id="mc_embed_signup_scroll"> 
										...
										<div class="mc-field-group">
											<label for="mce-EMAIL">
												<?php _e('Email Address',WP_AWP); ?>  <span class="asterisk">*</span>
											</label>
										...
										<div class="mc-field-group">
											<label for="mce-FNAME">
												<?php _e('First Name',WP_AWP); ?> <span class="asterisk">*</span>
											</label>
											<input type="text" value="" name="FNAME" class="required" id="mce-FNAME">
										</div>
										
										<div class="mc-field-group">
											<label for="mce-LNAME"><?php _e('Last Name',WP_AWP); ?> </label>
											<input type="text" value="" name="LNAME" class="" id="mce-LNAME">
										</div>
										
										<div class="mc-field-group">
											<label for="mce-WEBSITE">
												<?php _e('Website',WP_AWP); ?> <span class="asterisk">*</span>
											</label>
										...
										<div class="mc-field-group">
											<label for="mce-COUNTRY">
												<?php _e('Country',WP_AWP); ?> <span class="asterisk">*</span>
											</label>
